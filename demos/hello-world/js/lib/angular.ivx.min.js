...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createFactoryFunction=require("./utilities/create-factory-function.js"),_createFactoryFunction2=_interopRequireDefault(_createFactoryFunction),_audioEvents=require("../constants/audio.events.js"),_audioEvents2=_interopRequireDefault(_audioEvents),_stateEvents=require("../constants/state.events.js"),_stateEvents2=_interopRequireDefault(_stateEvents),_angularEvents=require("../constants/angular.events.js"),_angularEvents2=_interopRequireDefault(_angularEvents),AppRun=function e(t,n,a,i,o,r,u,s){if(_classCallCheck(this,e),o&&o.config){var c=o.config.metadata,d=void 0===c?{}:c,f=d.title,l=void 0===f?"iVX.js Player":f,_=new _audioEvents2["default"],p=new _stateEvents2["default"],v=new _angularEvents2["default"];t.pageTitle=l,o.Bus.on(p.GO,function(e){var t=e;Array.isArray(e)&&(t=e[0]),n.go(t.stateId)}),t.$on("$includeContentError",function(e,t){o.Bus.emit(v.TEMPLATE_NOT_FOUND,e)}),i.onSuccess({to:"*"},["$state","ivxjs.modules.audio",function(e,t){var n=e.current.data;o.Bus.emit(p.CHANGE,e.current),n.audio?(n.audio.id="state-audio",r.emit(_.SET_UP,n.audio)):t.pause(),e.current.data.restricted&&!function(){var t=o.experience.config.pageNotFoundState?o.experience.config.pageNotFoundState:o.experience.config.defaultState,n=o.experience.rules(t);o.experience.isRestricted&&o.experience.isRestricted().then(function(t){t&&e.go(n)})}()}]),r.on(_.ENDED,function(e){"state-audio"===e.id&&u.resolveActions(e.onEnd,function(){})}),r.on(p.REQUEST_STATE,function(){var e=n.current;e.data||!function(){var t=o.experience.config.defaultState,n=o.experience.rules(t);e.data=o.config.states.find(function(e){return e.id===n})}(),r.emit(p.GET_STATE,e)}),r.on(_.TIME_UPDATE,function(e){"state-audio"===e.id&&e.runCuePoints(o.experience.processor)})}};AppRun.$inject=["$rootScope","$state","$window","$transitions","iVXjs","ivxjs.bus","ivxjs.actions","ivxjs.constants"],exports["default"]=(0,_createFactoryFunction2["default"])(AppRun);
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function setUpCuePoints(e){var t=sortCuePoints(e);return t=t.map(function(e,t){return e.fired=!1,e})}function sortCuePoints(e){return e.sort(function(e,t){return e.timeAt>t.timeAt?1:e.timeAt<t.timeAt?-1:0})}Object.defineProperty(exports,"__esModule",{value:!0});var _createFactoryFunction=require("../utilities/create-factory-function.js"),_createFactoryFunction2=_interopRequireDefault(_createFactoryFunction),_videoEvents=require("../../constants/video.events.js"),_videoEvents2=_interopRequireDefault(_videoEvents),VideoStateController=function e(t,n,o,i){_classCallCheck(this,e);var r=n.current.data,a=r.playerSettings,s=r.onVideoEnd,c=void 0===s?[]:s,u=r.onVideoReady,l=void 0===u?[]:u,v=r.next,d=r.cuePoints,f=void 0===d?[]:d,m=a.autoplay,_=void 0===m?!1:m,E=new _videoEvents2["default"];f=setUpCuePoints(f),i.once(E.CAN_PLAY,function(e){var t=l.find(function(e,t){return"animateElement"===e.eventName&&".video-state-container"===e.args.element});t||l.push({eventName:"animateElement",args:{element:".video-state-container",animationClasses:"show"}}),o.resolveActions(l,function(){_&&(i.emit(E.PLAY),i.emit(E.ADD_PLAYING_CLASS))})}),i.once(E.ENDED,function(){console.log("GOT HERE?"),i.emit(E.DISPOSE),o.resolveThenNavigate(c,v)}),i.on(E.TIME_UPDATE,function(e,t){var n=e.currentTime;f.length<=0||f.forEach(function(e,t){var r=e.timeAt,a=e.fired,s=void 0===a?!1:a,c=e.always,u=void 0===c?!1:c;Math.abs(e.timeAt-n);n>=r&&(u||!s)&&(e.fired=!0,i.emit(e.eventName),o.resolveActions([e],function(){}))})})};VideoStateController.$inject=["$rootScope","$state","ivxjs.actions","ivxjs.bus"],exports["default"]=(0,_createFactoryFunction2["default"])(VideoStateController);
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,s){if(!(e instanceof s))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.Setup=void 0;var _createClass=function(){function e(e,s){for(var r=0;r<s.length;r++){var t=s[r];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(e,t.key,t)}}return function(s,r,t){return r&&e(s.prototype,r),t&&e(s,t),s}}(),_processor=require("./data/processor.js"),_registeredModules=require("./video/registered-modules.js"),_registeredModules2=require("./audio/registered-modules.js"),_asserts=require("../utilities/asserts.js"),_errors=require("../constants/errors.js"),_errors2=_interopRequireDefault(_errors),_iVXjsConfigEvents=require("../constants/iVXjs.config.events.js"),_iVXjsConfigEvents2=_interopRequireDefault(_iVXjsConfigEvents),_index=require("./data/ivx-js/index.js"),_index2=require("./ui/default/index.js"),_index3=require("./validation/ivx-js-validation/index.js"),errorEvents=new _errors2["default"],configEventNames=new _iVXjsConfigEvents2["default"],Setup=exports.Setup=function(){function e(){var s=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],r=arguments[1],t=arguments[2];_classCallCheck(this,e),this.settings=s,this.DataProcessor=_processor.DataProcessor,this.Bus=r,this.iVXjsLog=t}return _createClass(e,[{key:"runSetup",value:function(){var e=this,s=new Promise(function(s,r){e.resolveSetupProcesses(s,r)});return s}},{key:"resolveSetupProcesses",value:function(e,s){var r=this,t=this.iVXjsLog,i=this.settings,n=i.data,o=void 0===n?{}:n,u=o.module,a=void 0===u?_index.iVXjsData:u;this.setupData(a).then(function(s){var i=r.runValidation(s);if(i.valid){var n=r.setupModules(s);t.log("MODULE SUCCESS"),e(n)}else{var o=i.error;r.Bus.emit(configEventNames.NOT_VALID,i),t.error(o,"VALIDATION")}})}},{key:"runValidation",value:function(e){var s=e.validation,r=void 0===s?_index3.iVXjsValidation:s;return new r(e)}},{key:"setupData",value:function(e){var s=this.settings;return new this.DataProcessor(e,s,this.Bus,this.iVXjsLog).getData()}},{key:"setupModules",value:function(e){var s=this.settings,r=s.ui,t=void 0===r?_index2.DefaultUI:r;return e.video=new _registeredModules.RegisteredVideoModules,e.ui=new t,e.audio=(new _registeredModules2.RegisteredAudioModules).html5,e}}]),e}();
...
"use strict";function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},_createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var n=r[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(r,t,n){return t&&e(r.prototype,t),n&&e(r,n),r}}(),TypeValidator=exports.TypeValidator=function(){function e(){_classCallCheck(this,e)}return _createClass(e,[{key:"isUndefined",value:function(e){return void 0===e||null===e}},{key:"isString",value:function(e){return"[object String]"===this.toString.call(e)}},{key:"isNumber",value:function(e){return!isNaN(e)}},{key:"isBoolean",value:function(e){return"boolean"==typeof e||"object"===("undefined"==typeof e?"undefined":_typeof(e))&&"boolean"==typeof e.valueOf()}},{key:"isEmpty",value:function(e){var r=Object.prototype.hasOwnProperty,t=Array.isArray(e),n="string"==typeof e,o=t||n;if(o&&0===e.length)return!0;if(o&&e.length>0)return!1;if(!isNaN(e))return!1;if(void 0===e)return!0;if(null===e)return!0;for(var i in e)if(r.call(e,i))return!1;return!0}},{key:"toString",get:function(){return Object.prototype.toString}}]),e}(),typeValidator=new TypeValidator,ObjectParsers=exports.ObjectParsers=function(){function e(){_classCallCheck(this,e)}return _createClass(e,[{key:"mapKeys",value:function(e,r){if(!e||e==={})return[];var t=Object.keys(e),n=t.reduce(function(r,t){var n=[t,e[t]];return r.push(n),r},[]),o=new Map(n),i=[];return o?(o.forEach(function(e,t){i.push(r(e,t))}),i):[]}},{key:"merge",value:function(e,r,t){var n=Object.keys(r),o=new Object(e);return n.forEach(function(e,n){t&&t.indexOf(e)>=0||(o[e]=r[e])}),o}},{key:"reduce",value:function(e,r,t){if(e&&e!=={}){var n=Object.keys(e),o=n.reduce(function(r,t){var n=[t,e[t]];return r.push(n),r},[]),i=new Map(o);return i.forEach(function(e,n){t=r(t,e,n)}),t}}},{key:"anyEmpty",value:function(e,r){var t={isEmpty:!1,errors:[]};return e.forEach(function(e,n){r.forEach(function(r){typeValidator.isEmpty(e[r])&&(t.isEmpty=!0,t.errors.push({key:r,index:n,value:e[r]}))})}),t}},{key:"has",value:function(e,r){return Array.isArray(r)?this.hasSameArray(e,r):"object"===("undefined"==typeof r?"undefined":_typeof(r))?this.hasSameObject(e,r):e.indexOf(r)>=0}},{key:"hasSameObject",value:function(e,r){var t=!1;return e.forEach(function(e,n){if("object"===("undefined"==typeof e?"undefined":_typeof(e))){var o=Object.keys(e);o.forEach(function(n,o){t=e[n]===r[n]})}}),t}},{key:"hasSameArray",value:function(e,r){var t=!1;return e.forEach(function(e,n){Array.isArray(e)&&e.forEach(function(e,n){t=e===r[n]})}),t}},{key:"getValueFromPath",value:function(e,r){var t=e.split("."),n=r,o={},i=void 0;return t.forEach(function(e,r){if(!typeValidator.isEmpty(e)){if(o=n[e],typeValidator.isEmpty(o))return void(i=o);i=o,n=o}}),i}},{key:"isUnique",value:function(){var e=arguments.length<=0||void 0===arguments[0]?[]:arguments[0],r=arguments.length<=1||void 0===arguments[1]?[]:arguments[1],t={isUnique:!0,errors:[]},n={},o=this;return r.forEach(function(r){n[r]=[],e.forEach(function(e,i){var a=o.has(n[r],e[r]);a?(t.errors.push({key:r,index:i,value:e[r]}),t.isUnique=!1):n[r].push(e[r])})}),t}}]),e}();
