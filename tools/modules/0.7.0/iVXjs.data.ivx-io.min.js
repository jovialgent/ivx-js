...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,i){if(!(e instanceof i))throw new TypeError("Cannot call a class as a function")}function initializeiVXIO(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return e.module=iVXio,e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.iVXio=void 0;var _createClass=function(){function e(e,i){for(var t=0;t<i.length;t++){var r=i[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(i,t,r){return t&&e(i.prototype,t),r&&e(i,r),i}}(),_actions=require("./actions.js"),_rules=require("./rules.js"),_actions2=require("../ivx-js/actions.js"),_typeParsers=require("../../../utilities/type-parsers.js"),_asserts=require("../../../utilities/asserts.js"),_index=require("./input-validators/index.js"),_index2=_interopRequireDefault(_index),_iVXioErrors=require("../../../constants/iVXio.errors.js"),_iVXioErrors2=_interopRequireDefault(_iVXioErrors),typeValidator=new _typeParsers.TypeValidator,objectParser=new _typeParsers.ObjectParsers,iVXio=exports.iVXio=function(){function e(i){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=arguments[2],a=arguments[3];_classCallCheck(this,e),this.experienceHostSettings=i,this.iVXjsSettings=t,this.Bus=r,this.iVXjsLog=a}return _createClass(e,[{key:"enhance",value:function(){var e=this,i=this.experienceHostSettings,t=void 0===i?{}:i,r=this.iVXjsSettings,a=void 0===r?{}:r,n=new _iVXioErrors2.default,s=this,o=new Promise(function(i,r){return"undefined"==typeof iVX?(window.setTimeout(function(){s.Bus.emit(n.PLATFORM_UNAVAILABLE,{})},100),void r()):void iVX(t).then(function(t){if(!(t&&t.experience&&t.experience.story&&t.experience.story.data))return void window.setTimeout(function(){s.Bus.emit(n.PLATFORM_UNAVAILABLE,{})},100);var r=a.experience,o=void 0===r?{}:r,u=a.rules,c=objectParser.merge(new _actions2.Actions,o),l=objectParser.merge(c,t.experience),d=new _actions.iVXioActions(l,e.iVXjsLog),p=t.experience.story.data;p.ui,p.validation;t.experience.story.data.metadata=t.experience.story.data.metadata?t.experience.story.data.metadata:{};var x=new _rules.iVXioRules(l,u).rules,f=new _index2.default(t.experience.story.data.states,t.experience.story.inputs).states;l.whiteList=["self","http://ivx-xapi.*.inf-env.com/**","https://ivx-xapi.*.inf-env.com/**","https://xapi.ivx.io/**"],t.experience.story.data.states=f,t.experience.story.data.metadata.title=t.experience.story.data.metadata.title?t.experience.story.data.metadata.title:"iVX Story Player";var v={ui:a.ui,validation:a.validation,config:t.experience.story.data,experience:l,rules:x,actions:d};i(v)},function(e){s.Bus.emit(n.EXPERIENCE,e),r(e)})});return o}}]),e}();module.export=initializeiVXIO,angular&&angular.module("ivx-js")&&angular.module("ivx-js").constant("iVXjs.data.iVXio",initializeiVXIO);
...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var a=0;a<t.length;a++){var n=t[a];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,a,n){return a&&e(t.prototype,a),n&&e(t,n),t}}(),_class=function(){function e(t){var a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};_classCallCheck(this,e),this.inputData=t,this.TYPE="cascading-options",this.DATATREE=a.dataTree}return _createClass(e,[{key:"input",get:function(){var e=this.inputData,t=this.TYPE,a=this.DATATREE,n=JSON.parse(JSON.stringify(e));return n.type=t,n.dataTree=a,n}}]),e}();exports.default=_class;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var a=t[r];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,r,a){return r&&e(t.prototype,r),a&&e(t,a),t}}(),_textShort=require("./text-short.js"),_textShort2=_interopRequireDefault(_textShort),_textMedium=require("./text-medium.js"),_textMedium2=_interopRequireDefault(_textMedium),_textLarge=require("./text-large.js"),_textLarge2=_interopRequireDefault(_textLarge),_textarea=require("./textarea.js"),_textarea2=_interopRequireDefault(_textarea),_number=require("./number.js"),_number2=_interopRequireDefault(_number),_email=require("./email.js"),_email2=_interopRequireDefault(_email),_url=require("./url.js"),_url2=_interopRequireDefault(_url),_checkbox=require("./checkbox.js"),_checkbox2=_interopRequireDefault(_checkbox),_options=require("./options.js"),_options2=_interopRequireDefault(_options),_cascadingOptions=require("./cascading-options.js"),_cascadingOptions2=_interopRequireDefault(_cascadingOptions),_class=function(){function e(t,r){_classCallCheck(this,e),this.rawStates=JSON.parse(JSON.stringify(t)),this.storyInputs=r,this.states=this.validateInputStates(this.rawStates)}return _createClass(e,[{key:"validateInputStates",value:function(e){var t=this;return e.map(function(e,r){if("input"===e.type){var a=e.inputs;e.inputs=t.validateInputs(a)}return e})}},{key:"validateInputs",value:function(e){var t=this.inputValidators,r=this.storyInputs;return e.map(function(e,a){var i=e.name,u=r[i],n=u.display,s=t[n];return s?new s(e,u).input:e})}},{key:"inputValidators",get:function(){return{TextShort:_textShort2.default,TextMedium:_textMedium2.default,TextLarge:_textLarge2.default,TextArea:_textarea2.default,Number:_number2.default,Email:_email2.default,Url:_url2.default,Checkbox:_checkbox2.default,Options:_options2.default,CascadingOptions:_cascadingOptions2.default}}}]),e}();exports.default=_class;
...
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var a=0;a<e.length;a++){var i=e[a];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,a,i){return a&&t(e.prototype,a),i&&t(e,i),e}}(),_class=function(){function t(e,a){_classCallCheck(this,t);var i=a.attributes,r=void 0===i?{}:i,s=r.max,n=void 0===s?Number.MAX_SAFE_INTEGER:s,u=r.min,o=void 0===u?Number.MIN_SAFE_INTEGER:u,c=r.step,l=void 0===c?1:c;this.inputData=e,this.MIN=parseInt(o),this.STEP=parseInt(l),this.MAX=parseInt(n),this.TYPE="number"}return _createClass(t,[{key:"input",get:function(){var t=this.inputData,e=this.TYPE,a=this.MIN,i=this.MAX,r=this.STEP,s=JSON.parse(JSON.stringify(t)),n=s.attributes,u=void 0===n?{}:n,o=u.min,c=u.max,l=u.step;return s.type=e,s.attributes.min=o>=a?o:a,s.attributes.max=c<=i?c:i,s.attributes.step=l?l:r,s}}]),t}();exports.default=_class;

},{}],20:[function(require,module,exports){
"use strict";function _classCallCheck(t,n){if(!(t instanceof n))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,n){for(var e=0;e<n.length;e++){var u=n[e];u.enumerable=u.enumerable||!1,u.configurable=!0,"value"in u&&(u.writable=!0),Object.defineProperty(t,u.key,u)}}return function(n,e,u){return e&&t(n.prototype,e),u&&t(n,u),n}}(),_class=function(){function t(n){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};_classCallCheck(this,t),this.inputData=n,this.TYPE="options",this.OPTIONS=e.options}return _createClass(t,[{key:"setRadioButtonInput",value:function(t){var n=t.radioButtons,e=this.OPTIONS,u=n.reduce(function(t,n,u){var r=n.value,o=e.find(function(t,n){return t.value===r});return o&&t.push(n),t},[]);return t.radioButtons=u,t}},{key:"setButtonInput",value:function(t){var n=t.buttons,e=void 0===n?[]:n,u=this.OPTIONS,r=e.reduce(function(t,n,e){var r=n.value,o=u.find(function(t,n){return t.value===r});return o&&t.push(n),t},[]);return t.buttons=r,t}},{key:"input",get:function(){var t=this.inputData,n=this.TYPE,e=this.OPTIONS,u=t.type;return"buttons"===u?this.setButtonInput(t):"radio"===u?this.setRadioButtonInput(t):(t.type=n,t.options=e,t)}}]),t}();exports.default=_class;
