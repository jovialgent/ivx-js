...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createFactoryFunction=require("../utilities/create-factory-function.js"),_createFactoryFunction2=_interopRequireDefault(_createFactoryFunction),_inputController=require("../utilities/input-controller.js"),CascadingOptionsInputController=function(e){function t(e,n,o,r){_classCallCheck(this,t);var i=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e,n,r)),l=i,a=e.inputData,c=l.tree,s=void 0===c?a.dataTree:c;return s.options=[],s.isStatic&&s.labels.forEach(function(e,t){s.options[t]=[]}),s.options[0]=s.items,l.currentSelection=[{key:""}],l.tree=s,o.emit("update-view",s),l.modelUpdated=function(e){var t=l.tree,n=void 0===t?{}:t,r=(n.options,n.keys,e.key),i=e.items,a=r.split("~").length-1;l.finalValue=r,l.currentSelection[a]=e,a<n.labels.length-1&&i&&(l.currentSelection[a+1]={key:i[0].key},n.options[a+1]=i),l.tree=n,a<n.labels.length-1?o.emit("update-view",n):l.onChange(l.finalValue)},i}return _inherits(t,e),t}(_inputController.InputControllerHelper);CascadingOptionsInputController.$inject=["$scope","iVXjs","ivxjs.bus","ivxjs.actions"],exports.default=(0,_createFactoryFunction2.default)(CascadingOptionsInputController);
