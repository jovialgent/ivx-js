...
var Card = function Card($scope, iVXjsActions) {
    ...
    var settings = _$scope$settings === undefined ? {} : _$scope$settings;
    var _settings$img = settings.img;
    var img = _settings$img === undefined ? '' : _settings$img;
    var _settings$title = settings.title;
    var title = _settings$title === undefined ? '' : _settings$title;
    var _settings$firstName = settings.firstName;
    var firstName = _settings$firstName === undefined ? '' : _settings$firstName;
    var _settings$description = settings.description;
    var description = _settings$description === undefined ? '' : _settings$description;
    var _settings$events = settings.events;
    var events = _settings$events === undefined ? [] : _settings$events;
...
var DropdownInputController = function (_InputControllerHelpe) {
    ...
    function DropdownInputController($scope, $element, iVXjs, iVXjsActions) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DropdownInputController).call(this, $scope, iVXjs, iVXjsActions));
        ...
        var _$scope$inputData$set = _$scope$inputData.settings;
        var settings = _$scope$inputData$set === undefined ? {} : _$scope$inputData$set;
        var _settings$dropdown = settings.dropdown;
        var dropdown = _settings$dropdown === undefined ? {} : _settings$dropdown;
        var _dropdown$multiple = dropdown.multiple;
        var multiple = _dropdown$multiple === undefined ? false : _dropdown$multiple;
        ...
        _this.onChange = function (value) {
            ...
            var name = _$scope$inputData2.name;
            var _$scope$inputData2$on = _$scope$inputData2.onChange;
            var onChange = _$scope$inputData2$on === undefined ? [] : _$scope$inputData2$on;
...
var DropdownInput = function () {
    function DropdownInput($rootScope, $compile, $filter, $timeout, iVXjs, iVXjsUIModule, iVXjsBus) {
        ...
        this.link = function ($scope, iElm, iAttrs, controller) {
            ...
            var _input$attributes = input.attributes;
            var attributes = _input$attributes === undefined ? {} : _input$attributes;
            var options = input.options;
            var defaultDisplay = input.defaultDisplay;
...
var Buttons = exports.Buttons = function (_DefaultButtons) {
    ...
    function Buttons(buttons, inputData) {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(Buttons).call(this, buttons, inputData, _messages.ErrorMessages));
    }
...
var Dropdown = exports.Dropdown = function () {
    ...
    _createClass(Dropdown, [{
        ...
        get: function get() {
            ...
            var _errorMessages$messag = _errorMessages.messages;
            var errorMessages = _errorMessages$messag === undefined ? [] : _errorMessages$messag;
            var _errorMessages$attrib = _errorMessages.attributes;
            var errorAttributes = _errorMessages$attrib === undefined ? '' : _errorMessages$attrib;
            var _errorMessages$nonVal = _errorMessages.nonValidate;
            var nonValidate = _errorMessages$nonVal === undefined ? [] : _errorMessages$nonVal;
            var _errorMessages$tags = _errorMessages.tags;
            var errorTags = _errorMessages$tags === undefined ? '' : _errorMessages$tags;
...
var Style = exports.Style = function () {
    ...
    _createClass(Style, [{
        ...
        value: function getInputContainerClassNames(settings) {
            ...
            var _settings$containerCl = _settings.containerClass;
            var containerClass = _settings$containerCl === undefined ? 'field' : _settings$containerCl;
            var _settings$classes = _settings.classes;
            var classes = _settings$classes === undefined ? '' : _settings$classes;
