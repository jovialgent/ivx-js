...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,i){if(!(e instanceof i))throw new TypeError("Cannot call a class as a function")}function initializeFirebase(e){return e.module=FirebaseData,e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.FirebaseData=void 0;var _createClass=function(){function e(e,i){for(var t=0;t<i.length;t++){var a=i[t];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(i,t,a){return t&&e(i.prototype,t),a&&e(i,a),i}}(),_typeParsers=require("../../../utilities/type-parsers.js"),_iVXjsConfigEvents=require("../../../constants/iVXjs.config.events.js"),_iVXjsConfigEvents2=_interopRequireDefault(_iVXjsConfigEvents),_stateEvents=require("../../../constants/state.events.js"),_stateEvents2=_interopRequireDefault(_stateEvents),_firebaseAuthentication=require("../../../constants/firebase.authentication.js"),_firebaseAuthentication2=_interopRequireDefault(_firebaseAuthentication),_actions=require("../ivx-js/actions.js"),_rules=require("./rules.js"),_utilities=require("./utilities.js"),_utilities2=_interopRequireDefault(_utilities),_actions2=require("./actions.js"),_actions3=_interopRequireDefault(_actions2),defaultActions=new _actions.Actions,myObjectParser=new _typeParsers.ObjectParsers,utilities=new _utilities2["default"],FirebaseData=exports.FirebaseData=function(){function e(){var i=(arguments.length<=0||void 0===arguments[0]?{}:arguments[0],arguments.length<=1||void 0===arguments[1]?{}:arguments[1]),t=arguments[2],a=arguments[3];_classCallCheck(this,e);var s=i.data,r=i.experience,n=(r.data,s.apiKey),u=s.authDomain,o=s.databaseURL,c=s.storageBucket,l=s.auth,f=void 0===l?!1:l,d=s.createExperienceOnLoad,v=void 0===d?!0:d,h=s.experiencePath,p=void 0===h?"experiences":h,_=s.localTemplates,b=void 0===_?!1:_;this.iVXjsSettings=i,this.Bus=t,this.iVXjsLog=a;var g={apiKey:n,authDomain:u,databaseURL:o,storageBucket:c};firebase.initializeApp(g),this.auth=f,this.databaseURL=o,this.firebaseConstants=new _firebaseAuthentication2["default"],this.createExperienceOnLoad=v,this.experiencePath=p,this.localTemplates=b,this.defaultExperience=r}return _createClass(e,[{key:"setUpExperience",value:function(e,i,t){function a(){var a=firebase.auth().currentUser;m.src=i,m.user=a,m.iVXjsLog=h.iVXjsLog;var s={config:e,experience:x,rules:new _rules.Rules(m,j).rules};t(s)}function s(i,a){var s=a.key,r=a.next;m.key=s,m.user=i,m.iVXjsLog=h.iVXjsLog,h.Bus.once((new _iVXjsConfigEvents2["default"]).VALIDATED,function(e){e.experience.goToNextState({next:r})});var u={config:e,experience:x,rules:new _rules.Rules(m,j).rules};p.ref("users/"+i.uid).once("value").then(function(e){if(null===e.val()){var a={};a[i.uid]={email:i.email},p.ref("users").set(a).then(function(e){n(i,s,t,u)})}else{var r=e.val();r.uid=i.uid,n(r,s,t,u)}})}function r(){var a=firebase.auth().currentUser,s={src:i},r=utilities.detokenize(l,a,c),o=void 0;a&&(s.user={},s.user[a.uid]=!0,m.user=a),r&&(o=firebase.database().ref(r).push(s).key),m.key=o,m.auth=u,m.src=i,m.iVXjsLog=h.iVXjsLog;var f={config:e,experience:x,rules:new _rules.Rules(m,j).rules};return a&&r?(m.user=a,void p.ref("users/"+a.uid).once("value").then(function(e){if(null===e.val())!function(){var e={},i={email:a.email,name:a.displayName,photoURL:a.photoURL,uid:a.uid};e[a.uid]=i,p.ref("users").set(e).then(function(e){n(i,o,t,f)})}();else{var i=e.val(),s=i.uid,r=void 0===s?a.uid:s,u=i.email,c=void 0===u?a.email:u,l=i.name,d=void 0===l?a.displayName:l,v=i.avatar,h=void 0===v?a.photoURL:v,_=i.experiences,b=void 0===_?{}:_,g={uid:r,email:c,name:d,avatar:h,experiences:b};n(g,o,t,f)}})):void t(f)}function n(e,i,t,a){var s=e.experiences,r=void 0===s?{}:s,n=e.uid;delete e.uid,r[i]=!0,e.experiences=r,p.ref("users/"+n).update(e),t(a)}var u=this.auth,o=this.createExperienceOnLoad,c=this.defaultExperience,l=this.experiencePath,f=this.localTemplates,d=this.firebaseConstants,v=this.iVXjsLog,h=this,p=firebase.database(),_=this.iVXjsSettings,b=_.experience,g=void 0===b?{}:b,j=_.rules,m=(_.ui,_.validation,myObjectParser.merge(new _actions.Actions,g)),x=myObjectParser.merge(m,new _actions3["default"](this.iVXjsLog).experienceActions);m.experiencePath=l,m.localTemplates=f,firebase.auth().getRedirectResult().then(function(e){var i=e.user;if(!o)return void a();if(i&&localStorage){var t=localStorage,n=t.redirectOrigin,u=JSON.parse(n),c=e.user;e.crediential;s(c,u)}else r()})["catch"](function(e){h.Bus.emit(d.ACCOUNT_EXISTS,e),console.dir(e);var i={message:"Firebase couldn't authenticate with email, "+e.email+", due to error code "+e.code+". \n            You can handle this error by listening for event: "+d.ACCOUNT_EXISTS+".",type:"FIREBASE:AUTHENTICATION"};v.error(i,"Firebase")})}},{key:"enhance",value:function(){var e=this,i=(e.auth,e.iVXjsSettings),t=(e.databaseURL,i.config),a=firebase.database(),s=new Promise(function(i,s){a.ref(t).once("value").then(function(a){e.setUpExperience(a.val(),t,i)})});return s}}]),e}();module["export"]=initializeFirebase,angular&&angular.module("ivx-js")&&angular.module("ivx-js").constant("iVXjs.data.firebase",initializeFirebase).provider("iVXjsFirebaseUtilities",function(){this.utilities=new _utilities2["default"],this.$get=function(){}});
