...
var _class = function () {
    ...
    _createClass(_class, [{
        ...
        value: function createExperience(eventObj) {
            ...
            var defaultData = _eventObj$data === undefined ? {} : _eventObj$data;
                    ...
                    if (currentUser) {
                        (function () {
                            ...
                            database.ref("users/" + uid).once('value').then(function (data) {
                                ...
                                var experiences = _data$val.experiences;
        ...
        value: function handleRedirect(stateData, provider, args) {
            ...
            var scope = _args$scope === undefined ? [] : _args$scope;
        ...
        value: function setData(eventObj) {
            ...
            var data = _self$data === undefined ? {} : _self$data;
            var experienceKey = self.key;
            var auth = self.auth;
            var iVXjsLog = self.iVXjsLog;
            var experiencePath = self.experiencePath;
            var key = eventObj.key;
            var value = eventObj.value;
            var ref = eventObj.ref;
            var _eventObj$user = eventObj.user;
            var user = _eventObj$user === undefined ? false : _eventObj$user;
...
var FirebaseData = exports.FirebaseData = function () {
    function FirebaseData() {
        ...
        var defaultExperience = iVXjsSettings.experience;
        var _defaultExperience$da = defaultExperience.data;
        var defaultExperienceData = _defaultExperience$da === undefined ? {} : _defaultExperience$da;
        var apiKey = data.apiKey;
        var authDomain = data.authDomain;
        var databaseURL = data.databaseURL;
        var storageBucket = data.storageBucket;
        var _data$auth = data.auth;
        var auth = _data$auth === undefined ? false : _data$auth;
        var _data$createExperienc = data.createExperienceOnLoad;
        var createExperienceOnLoad = _data$createExperienc === undefined ? true : _data$createExperienc;
        var _data$experiencePath = data.experiencePath;
    ...
    _createClass(FirebaseData, [{
        ...
        value: function setUpExperience(configData, src, resolve) {
            ...
            var _iVXjsSettings$experi = _iVXjsSettings.experience;
            var modifiedExperience = _iVXjsSettings$experi === undefined ? {} : _iVXjsSettings$experi;
                ...
                if (user && detokenedExperiencePath) {
                    ...
                    database.ref('users/' + user.uid).once('value').then(function (data) {
                        if (data.val() === null) {
                            ...
                            var uid = _currentUserDataFromS === undefined ? user.uid : _currentUserDataFromS;
                            var _currentUserDataFromS2 = currentUserDataFromServer.email;
                            var email = _currentUserDataFromS2 === undefined ? user.email : _currentUserDataFromS2;
                            var _currentUserDataFromS3 = currentUserDataFromServer.name;
                            var name = _currentUserDataFromS3 === undefined ? user.displayName : _currentUserDataFromS3;
                            var _currentUserDataFromS4 = currentUserDataFromServer.avatar;
                            var avatar = _currentUserDataFromS4 === undefined ? user.photoURL : _currentUserDataFromS4;
                            var _currentUserDataFromS5 = currentUserDataFromServer.experiences;
                            var experiences = _currentUserDataFromS5 === undefined ? {} : _currentUserDataFromS5;
            ...
            function addExperienceToUser(userData, experienceKey, resolve, enhanced) {
                ...
                var experiences = _userData$experiences === undefined ? {} : _userData$experiences;
        ...
        value: function enhance() {
            var self = this;
            var auth = self.auth;
            var iVXjsSettings = self.iVXjsSettings;
            var databaseURL = self.databaseURL;
...
var Rules = exports.Rules = function (_DefaultRules) {
    ...
    function Rules() {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Rules).call(this, experience, customRules));
...
var _class = function () {
    ...
    _createClass(_class, [{
        ...
        value: function detokenize(ref) {
            ...
            var iVXjsLog = arguments.length <= 3 || arguments[3] === undefined ? console : arguments[3];
            var data = experience.data;
            var experienceKey = experience.key;
