...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,i){if(!(e instanceof i))throw new TypeError("Cannot call a class as a function")}function initializeiVXIO(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return e.module=iVXio,e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.iVXio=void 0;var _createClass=function(){function e(e,i){for(var t=0;t<i.length;t++){var r=i[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(i,t,r){return t&&e(i.prototype,t),r&&e(i,r),i}}(),_actions=require("./actions.js"),_rules=require("./rules.js"),_actions2=require("../ivx-js/actions.js"),_typeParsers=require("../../../utilities/type-parsers.js"),_asserts=require("../../../utilities/asserts.js"),_index=require("./input-validators/index.js"),_index2=_interopRequireDefault(_index),_iVXioErrors=require("../../../constants/iVXio.errors.js"),_iVXioErrors2=_interopRequireDefault(_iVXioErrors),typeValidator=new _typeParsers.TypeValidator,objectParser=new _typeParsers.ObjectParsers,iVXio=exports.iVXio=function(){function e(i){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=arguments[2],n=arguments[3];_classCallCheck(this,e),this.experienceHostSettings=i,this.iVXjsSettings=t,this.Bus=r,this.iVXjsLog=n}return _createClass(e,[{key:"enhance",value:function(){var e=this,i=this.experienceHostSettings,t=void 0===i?{}:i,r=this.iVXjsSettings,n=void 0===r?{}:r,s=new _iVXioErrors2.default,a=this,o=new Promise(function(i,r){return"undefined"==typeof iVX?(window.setTimeout(function(){a.Bus.emit(s.PLATFORM_UNAVAILABLE,{})},100),void r()):(a.Bus.once(s.EXPERIENCE,function(e){r(e)}),void iVX(t).then(function(o){if(console.log(o.experience),!(o&&o.experience&&o.experience.story&&o.experience.story.data))return void window.setTimeout(function(){a.Bus.emit(s.PLATFORM_UNAVAILABLE,{})},100);var u=n.experience,c=void 0===u?{}:u,l=n.rules,d=objectParser.merge(new _actions2.Actions,c),p=objectParser.merge(d,o.experience),x=new _actions.iVXioActions(p,e.iVXjsLog),f=o.experience.story.data;f.ui,f.validation;o.experience.story.data.metadata=o.experience.story.data.metadata?o.experience.story.data.metadata:{};var v=new _rules.iVXioRules(p,l).rules,_=new _index2.default(o.experience.story.data.states,o.experience.story.inputs,a,r).states;p.debugHost=t.debug,p.whiteList=["self","http://ivx-xapi.*.inf-env.com/**","https://ivx-xapi.*.inf-env.com/**","https://xapi.ivx.io/**"],o.experience.story.data.states=_,o.experience.story.data.metadata.title=o.experience.story.data.metadata.title?o.experience.story.data.metadata.title:"iVX Story Player";var y={ui:n.ui,validation:n.validation,config:o.experience.story.data,experience:p,rules:v,actions:x};i(y)},function(e){a.Bus.emit(s.EXPERIENCE,e),r(e)}))});return o}}]),e}();module.export=initializeiVXIO,angular&&angular.module("ivx-js")&&angular.module("ivx-js").constant("iVXjs.data.iVXio",initializeiVXIO);
