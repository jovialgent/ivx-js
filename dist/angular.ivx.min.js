...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createFactoryFunction=require("../utilities/create-factory-function.js"),_createFactoryFunction2=_interopRequireDefault(_createFactoryFunction),_inputController=require("../utilities/input-controller.js"),CascadingOptionsInputController=function(e){function t(e,n,r,o){_classCallCheck(this,t);var i=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e,n,o)),l=i,c=e.inputData,u=l.tree,a=void 0===u?c.dataTree:u,s=c.name,p=n.experience.data;return a.options=[],a.isStatic&&a.labels.forEach(function(e,t){a.options[t]=[]}),a.options[0]=a.items,l.currentSelection=[{key:""}],l.tree=a,l.modelUpdated=function(e){if(null!==e){var t=l.tree,n=void 0===t?{}:t,o=(n.options,n.keys,e.key),i=e.items,c=o.split("~").length-1;l.finalValue=o,i&&i.length&&(l.finalValue=i[0].key),l.currentSelection[c]=e,c<n.labels.length-1&&i&&(l.currentSelection[c+1]={key:i[0].key},n.options[c+1]=i),l.tree=n,c<n.labels.length-1&&r.emit("update-view",n),l.onChange(l.finalValue)}},p[s]&&p[s].split&&!function(){var e=p[s].split("~"),t=e[0],n=(e.slice(1),t);n="",l.currentSelection=e.map(function(e,t){return n=""+(t>0?n+"~":"")+e,{key:n}});var r=l.currentSelection.reduce(function(e,t,n){var r=e[n],o=r.find(function(e){return e.key===t.key});return o&&o.items&&o.items.length&&o.items.length>=1&&(e=[].concat(e,[o.items])),e},l.tree.options);l.tree.options=r}(),r.emit("update-view",a),i}return _inherits(t,e),t}(_inputController.InputControllerHelper);CascadingOptionsInputController.$inject=["$scope","iVXjs","ivxjs.bus","ivxjs.actions"],exports.default=(0,_createFactoryFunction2.default)(CascadingOptionsInputController);
...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.CascadingOptions=void 0;var _createClass=function(){function t(t,e){for(var i=0;i<e.length;i++){var n=e[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,i,n){return i&&t(e.prototype,i),n&&t(e,n),e}}(),_createFactoryFunction=require("../utilities/create-factory-function.js"),_createFactoryFunction2=_interopRequireDefault(_createFactoryFunction),_uiCascadingOptions=require("../controllers/ui.cascading-options.js"),_uiCascadingOptions2=_interopRequireDefault(_uiCascadingOptions),_messagesError=require("../utilities/messages.error.js"),CascadingOptions=exports.CascadingOptions=function(){function t(e,i,n,o,a){_classCallCheck(this,t),this.template=this.templateHTML,this.restrict="E",this.scope={inputData:"=inputData"},this.controller=_uiCascadingOptions2.default,this.controllerAs="vm",this.replace=!0,this.link=function(t,n,s,r){function c(o){var s=o.options,r=o.labels,c="";c=s.map(function(t,e,i){var n=r[e],o="\n                           ng-change='vm.modelUpdated(vm.currentSelection["+e+"])'\n                           ng-options=\"option.name for option in vm.tree.options["+e+"] track by option.key\" \n                           ng-model='vm.currentSelection["+e+"]'",s={input:{id:u.id+"-"+e,options:t,width:u.width,label:n},defaultDisplay:n,settings:{},tags:o,errors:{}},c=new a.options(s).html,l=u.settings,p=void 0===l?{}:l,d=p.input,f=void 0===d?{}:d;return{html:"<div class='ivxjs-grid-1-1'>"+c+"</div>",settings:f}}),c=""+a.style.addWidthClasses(c),n.html(c),e(n.contents())(t),i(function(){a.initializeInput&&a.initializeInput()},1)}var u=t.inputData;c(r.tree),o.on("update-view",function(t){c(t)})}}return _createClass(t,[{key:"templateHTML",get:function(){return"<div></div>"}}]),t}();CascadingOptions.$inject=["$compile","$timeout","iVXjs","ivxjs.bus","ivxjs.modules.ui"],exports.default=(0,_createFactoryFunction2.default)(CascadingOptions);
