...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.Radio=void 0;var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var i=t[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,r,i){return r&&e(t.prototype,r),i&&e(t,i),t}}(),_messages=require("./messages.js"),_attributes=require("../utilities/attributes.js"),Radio=exports.Radio=function(){function e(t){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:_messages.ErrorMessages;_classCallCheck(this,e);var i=t.input,s=void 0===i?{}:i,n=t.radios,a=void 0===n?[]:n,o=t.errors,u=void 0===o?{}:o,l=t.settings,d=void 0===l?{}:l;this.radios=a,this.errors=u,this.settings=d,this.input=s,this.errorMessages=r,this.attributeTags=_attributes.AttributeTags}return _createClass(e,[{key:"uiRadioGroup",value:function(e){return e}},{key:"uiRadioButtonContainer",value:function(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"",i=this.input.id;return' \n        <label for="'+i+(r.length>0?"-"+r:"")+'" class="'+t+'">\n        '+e+"\n        </label>"}},{key:"renderRadioHTML",value:function(e,t){return' \n            <input type="radio" '+e+">\n            "+t}},{key:"uiClasses",get:function(){return""}},{key:"uiAttributes",get:function(){return""}},{key:"html",get:function(){var e=this.errors,t=this.radios,r=this.settings,i=this.input,s=this.uiClasses,n=e.messages,a=e.tags,o=void 0===a?"":a,u=this,l=i.label,d=i.labelHTML;r.showLabel;d&&(l=d);var c=t.reduce(function(e,t,r){var n=t.label,a=t.attrHTML,l=void 0===a?"":a,d=t.classes,c=void 0===d?"":d;t.value;l=l+" "+o;var v=u.renderRadioHTML(l,n,i.radioButtons[r].value);return e+"\n            "+u.uiRadioButtonContainer(v,s+" "+c,i.radioButtons[r].value)},l),v=new this.errorMessages(n).html,h="\n             "+c+"\n             "+v;return this.uiRadioGroup(h)}}]),e}();
