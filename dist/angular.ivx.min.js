...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function setUpCuePoints(e){var t=sortCuePoints(e);return t=t.map(function(e,t){return e.fired=!1,e})}function sortCuePoints(e){return e.sort(function(e,t){return e.timeAt>t.timeAt?1:e.timeAt<t.timeAt?-1:0})}Object.defineProperty(exports,"__esModule",{value:!0});var _createFactoryFunction=require("../utilities/create-factory-function.js"),_createFactoryFunction2=_interopRequireDefault(_createFactoryFunction),_videoEvents=require("../../constants/video.events.js"),_videoEvents2=_interopRequireDefault(_videoEvents),VideoStateController=function e(t,n,o,i,r){_classCallCheck(this,e);var a=n.current.data,s=a.playerSettings,c=a.onVideoEnd,u=void 0===c?[]:c,l=a.onVideoReady,v=void 0===l?[]:l,d=a.next,f=a.cuePoints,m=void 0===f?[]:f,_=s.autoplay,A=void 0!==_&&_,C=new _videoEvents2.default;m=setUpCuePoints(m),i.once(C.CAN_PLAY,function(e){var t=v.find(function(e,t){return"animateElement"===e.eventName&&".video-state-container"===e.args.element});t||v.push({eventName:"animateElement",args:{element:".video-state-container",animationClasses:"show"}}),o.resolveActions(v,function(){A&&(i.emit(C.PLAY),i.emit(C.ADD_PLAYING_CLASS))})}),i.once(C.ENDED,function(){i.emit(C.DISPOSE),o.resolveThenNavigate(u,d)}),i.on(C.TIME_UPDATE,function(e,t){var n=e.currentTime;m.length<=0||m.forEach(function(e,t){var r=e.timeAt,a=e.fired,s=void 0!==a&&a,c=e.always,u=void 0!==c&&c;Math.abs(e.timeAt-n);r<=n&&(u||!s)&&(e.fired=!0,i.emit(e.eventName),o.resolveActions([e],function(){}))})})};VideoStateController.$inject=["$rootScope","$state","ivxjs.actions","ivxjs.bus","iVXjs"],exports.default=(0,_createFactoryFunction2.default)(VideoStateController);
