...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createFactoryFunction=require("../utilities/create-factory-function.js"),_createFactoryFunction2=_interopRequireDefault(_createFactoryFunction),_stateData=require("../utilities/state-data.js"),_stateData2=_interopRequireDefault(_stateData),_audioEvents=require("../../constants/audio.events.js"),_audioEvents2=_interopRequireDefault(_audioEvents),InputStateController=function t(e,a,i,n,o,u,s){_classCallCheck(this,t);var r=new _stateData2.default(e),c=r.stateData,l=c.inputs,d=c.id,_=(c.headerHTML,c.footerHTML,c.name,c.next),f=void 0===_?[]:_,p=c.onSubmit,v=void 0===p?[]:p;c.onInputReady,c.audio,new _audioEvents2.default;this.inputs=l,this.id=d,this.stateID=d,this.onSubmit=function(t){t&&t.$valid&&o.resolveThenNavigate(v,f)},n(function(){},1)};InputStateController.$inject=["$state","$scope","$rootScope","$timeout","ivxjs.actions","ivxjs.bus","ivxjs.modules.ui"],exports.default=(0,_createFactoryFunction2.default)(InputStateController);
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var a=t[n];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,n,a){return n&&e(t.prototype,n),a&&e(t,a),t}}(),_createFactoryFunction=require("../utilities/create-factory-function.js"),_createFactoryFunction2=_interopRequireDefault(_createFactoryFunction),_stateHtml=require("../controllers/state.html.js"),_stateHtml2=_interopRequireDefault(_stateHtml),_audioEvents=require("../../constants/audio.events.js"),_audioEvents2=_interopRequireDefault(_audioEvents),_httpEvents=require("../../constants/http.events.js"),_httpEvents2=_interopRequireDefault(_httpEvents),HTTPEvents=new _httpEvents2.default,HtmlState=function(){function e(t,n,a,i,r,s,o,l,c){_classCallCheck(this,e),this.template=this.templateHTML,this.restrict="E",this.replace=!0,this.scope={},this.controller=_stateHtml2.default,this.controllerAs="vm",this.link=function(e,n,l,u){var m=t.current.data,f=(m.id,m.html),v=m.templateUrl,d=m.onCompile,p=void 0===d?[]:d,_=m.audio,h=new _audioEvents2.default;if(v){var E=i.getTrustedResourceUrl(v);u.safeTemplateUrl=E,n.html('<div class="html-state-container" ng-include="vm.safeTemplateUrl"></div>')}else n.html(f);e.experience=s.experience.data,r(function(){var e=p.find(function(e,t){return"animateElement"===e.eventName&&".html-state-container"===e.args.element});e||p.push({eventName:"animateElement",args:{element:".html-state-container",animationClasses:"show"}}),v?c.once(HTTPEvents.RESPONSE_SUCCESS,function(){o.resolveActions(p,function(){_&&_.src&&c.emit(h.PLAY)})}):o.resolveActions(p,function(){_&&_.src&&c.emit(h.PLAY)})},1),a(n.contents())(e)}}return _createClass(e,[{key:"templateHTML",get:function(){return'<div class="html-state-container" id="{{vm.id}}"></div>'}}]),e}();HtmlState.$inject=["$state","$http","$compile","$sce","$timeout","iVXjs","ivxjs.actions","ivxjs.modules.audio","ivxjs.bus"],exports.default=(0,_createFactoryFunction2.default)(HtmlState);

},{"../../constants/audio.events.js":364,"../../constants/http.events.js":367,"../controllers/state.html.js":314,"../utilities/create-factory-function.js":357}],336:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var n=0;n<e.length;n++){var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),_createFactoryFunction=require("../utilities/create-factory-function.js"),_createFactoryFunction2=_interopRequireDefault(_createFactoryFunction),_stateInput=require("../controllers/state.input.js"),_stateInput2=_interopRequireDefault(_stateInput),_audioEvents=require("../../constants/audio.events.js"),_audioEvents2=_interopRequireDefault(_audioEvents),InputState=function(){function t(e,n,i,a,r,o,s){_classCallCheck(this,t),this.template=this.templateHTML,this.replace=!0,this.restrict="E",this.scope={},this.controller=_stateInput2.default,this.controllerAs="vm",this.link=function(t,i,u,c){var l=e.current.data,p=l,f=(p.headerHTML,p.footerHTML,p.onInputReady),m=void 0===f?[]:f,v=p.form,d=void 0===v?{}:v,_=p.header,h=void 0===_?{}:_,j=p.footer,y=void 0===j?{}:j,I=p.audio,F=new _audioEvents2.default,b="<ivxjs-form-input inputs='vm.inputs' form-id='vm.id' on-submit='vm.onSubmit' form-settings=\"vm.formSettings\"></ivxjs-form-input>";l=s.convertHeaderFooter(h,y,l,c);var g=new o.states.input(b,l);t.experience=a.experience.data,c.formSettings=d,i.html(g.html),n(i.contents())(t,function(t){o.initializeInput&&o.initializeInput();var e=m.find(function(t,e){return"animateElement"===t.eventName&&".input-state-container"===t.args.element});i.html(t),e||m.push({eventName:"animateElement",args:{element:".input-state-container",animationClasses:"show"}}),r.resolveActions(m,function(){I&&I.src&&iVXjsBus.emit(F.PLAY)})})}}return _createClass(t,[{key:"templateHTML",get:function(){return'<div class="input-state-container"></div>'}}]),t}();InputState.$inject=["$state","$compile","$sce","iVXjs","ivxjs.actions","ivxjs.modules.ui","pullInTemplate"],exports.default=(0,_createFactoryFunction2.default)(InputState);
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.Actions=void 0;var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var a=t[n];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,n,a){return n&&e(t.prototype,n),a&&e(t,a),t}}(),_audioEvents=require("../../../constants/audio.events.js"),_audioEvents2=_interopRequireDefault(_audioEvents),_stateEvents=require("../../../constants/state.events.js"),_stateEvents2=_interopRequireDefault(_stateEvents),_index=require("../../animation/vanilla/index.js"),_index2=_interopRequireDefault(_index),_eventStore=require("../../../core/event-store.js"),_eventStore2=_interopRequireDefault(_eventStore),Actions=exports.Actions=function(){function e(){_classCallCheck(this,e),this.data={},this.audioEventNames=new _audioEvents2.default,this.stateEventNames=new _stateEvents2.default,this.animation=new _index2.default,this.EventStore=new _eventStore2.default}return _createClass(e,[{key:"setElementClasses",value:function(e,t){var n=t.animationClasses,a=void 0===n?"":n,i=e.animationClass;if(!(e.className.indexOf(a)>=0))return e.className.indexOf("hide")>=0?void(e.className=e.className.replace("hide",a)):(i&&(e.className=e.className.replace(i,"")),e.animationClass=a,e.className=e.className+" "+a,e)}},{key:"goToNextState",value:function(e){var t=this,n=e.next,a=this,i=this.rules(n),s=new Promise(function(e,n){i&&(t.Bus.emit(a.stateEventNames.GO,{stateId:i}),e())});return s}},{key:"animateElement",value:function(e){var t=this,n=e.element,a=e.type,i=document.querySelectorAll(n);if("tween"===a){var s=e.tweens;return console.log(i),void this.animation.runTweens(s,this)}if(i&&!(i.length<=0)){i=Array.from(i),i.forEach(function(n,a){n=t.setElementClasses(n,e)});var o=new Promise(function(t,n){function a(n){i.forEach(function(t,n){s.forEach(function(n){t.animationClass=e.animationClasses,t.removeEventListener(n,a)})}),t()}var s=["webkitAnimationEnd","mozAnimationEnd","MSAnimationEnd","osanimationend","animationend"];s.forEach(function(e){i.forEach(function(t,n){t.addEventListener(e,a)})})});return o}}},{key:"goToState",value:function(e,t){e.state;t&&t.emit(this.stateEventNames.GO,e)}},{key:"playAudioClip",value:function(e){var t=this.audioEventNames,n=this;e&&(this.Bus.emit(t.SET_UP,e),this.Bus.emit(t.PLAY)),this.Bus.on(t.TIME_UPDATE,function(t){t.id===e.id&&t.runCuePoints(n.processor)});var a=new Promise(function(a,i){n.Bus.once(t.ENDED,function(t){t.id===e.id&&n.processor.resolveActions(e.onEnd,function(){a()})})});return a}},{key:"clearData",value:function(e){var t=e.keys,n=this;t.forEach(function(e){n.data[e]=void 0})}},{key:"setData",value:function(e){var t=e.key,n=e.value,a=this,i=new Promise(function(e,i){a.data[t]=n,e(a)});return i}}]),e}();
