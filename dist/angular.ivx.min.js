...
"use strict";function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.ActionProcessor=void 0;var _createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var i=r[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(r,t,i){return t&&e(r.prototype,t),i&&e(r,i),r}}(),_typeParsers=require("../utilities/type-parsers.js"),typeValidator=new _typeParsers.TypeValidator,ActionProcessor=exports.ActionProcessor=function(){function e(r){_classCallCheck(this,e),this.iVXjs=r}return _createClass(e,[{key:"resolveActions",value:function(e,r){var t=this;if(typeValidator.isEmpty(e))return void r();var i=e.map(function(e){return t.iVXjs.Bus.emit(e.eventName,e.args),t.iVXjs.actions&&t.iVXjs.actions[e.eventName]?t.iVXjs.actions[e.eventName](e.args):t.iVXjs.experience[e.eventName]?t.iVXjs.experience[e.eventName](e.args):void 0});Promise.all(i).then(function(e){r()}).catch(function(e){console.error("iVXjs: NOT ALL ACTIONS RESOLVED"),console.dir(e),t.iVXjs.Bus.emit("iVXjs:iVXio:error:event-not-fired",e)})}}]),e}();
