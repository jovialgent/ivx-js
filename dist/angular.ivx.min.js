...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var n=0;n<e.length;n++){var a=e[n];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(t,a.key,a)}}return function(e,n,a){return n&&t(e.prototype,n),a&&t(e,a),e}}(),_createFactoryFunction=require("../utilities/create-factory-function.js"),_createFactoryFunction2=_interopRequireDefault(_createFactoryFunction),_stateInput=require("../controllers/state.input.js"),_stateInput2=_interopRequireDefault(_stateInput),_audioEvents=require("../../constants/audio.events.js"),_audioEvents2=_interopRequireDefault(_audioEvents),InputState=function(){function t(e,n,a,i,o,r,s){_classCallCheck(this,t),this.template=this.templateHTML,this.replace=!0,this.restrict="E",this.scope={},this.controller=_stateInput2.default,this.controllerAs="vm",this.link=function(t,a,u,c){var l=e.current.data,p=l,d=(p.headerHTML,p.footerHTML,p.onInputReady),m=void 0===d?[]:d,f=p.form,v=void 0===f?{}:f,_=p.header,h=void 0===_?{}:_,y=p.footer,I=void 0===y?{}:y,g=p.audio,j=new _audioEvents2.default,b="<ivxjs-form-input inputs='vm.inputs' form-id='vm.id' on-submit='vm.onSubmit' form-settings=\"vm.formSettings\"></ivxjs-form-input>";l=s.convertHeaderFooter(h,I,l,c);var C=new r.states.input(b,l);t.experience=i.experience.data,c.formSettings=v,a.html(C.html),n(a.contents())(t,function(t){r.initializeInput&&r.initializeInput();var e=m.find(function(t,e){return"animateElement"===t.eventName&&".input-state-container"===t.args.element});a.html(t),e||m.push({eventName:"animateElement",args:{element:".input-state-container",animationClasses:"show"}}),i.log.debug("onInputReady Started",{},{state:l,source:"onInputReady",status:"started",actions:m,timestamp:Date.now()}),o.resolveActions(m,function(){i.log.debug("onInputReady Completed",{},{state:l,source:"onInputReady",status:"completed",actions:m,timestamp:Date.now()}),g&&g.src&&iVXjsBus.emit(j.PLAY)})})}}return _createClass(t,[{key:"templateHTML",get:function(){return'<div class="input-state-container"></div>'}}]),t}();InputState.$inject=["$state","$compile","$sce","iVXjs","ivxjs.actions","ivxjs.modules.ui","pullInTemplate"],exports.default=(0,_createFactoryFunction2.default)(InputState);
