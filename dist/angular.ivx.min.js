...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var a=0;a<t.length;a++){var n=t[a];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,a,n){return a&&e(t.prototype,a),n&&e(t,n),t}}(),_createFactoryFunction=require("../utilities/create-factory-function.js"),_createFactoryFunction2=_interopRequireDefault(_createFactoryFunction),_stateHtml=require("../controllers/state.html.js"),_stateHtml2=_interopRequireDefault(_stateHtml),_audioEvents=require("../../constants/audio.events.js"),_audioEvents2=_interopRequireDefault(_audioEvents),HtmlState=function(){function e(t,a,n,i,r,s,o,l,c){_classCallCheck(this,e),this.template=this.templateHTML,this.restrict="E",this.replace=!0,this.scope={},this.controller=_stateHtml2.default,this.controllerAs="vm",this.link=function(e,a,l,u){var m=t.current.data,d=(m.id,m.html),f=m.templateUrl,p=m.onCompile,v=void 0===p?[]:p,h=m.audio,_=new _audioEvents2.default;if(f){var C=i.getTrustedResourceUrl(f);u.safeTemplateUrl=C,a.html('<div class="html-state-container" ng-include="vm.safeTemplateUrl"></div>')}else a.html(d);e.experience=s.experience.data,r(function(){var e=v.find(function(e,t){return"animateElement"===e.eventName&&".html-state-container"===e.args.element});e||v.push({eventName:"animateElement",args:{element:".html-state-container",animationClasses:"show"}}),s.log.debug("onCompile Started",{},{state:t.current.data,source:"onCompile",status:"started",actions:v,timestamp:Date.now()}),o.resolveActions(v,function(){s.log.debug("onCompile Completed",{},{state:t.current.data,source:"onCompile",status:"completed",actions:v,timestamp:Date.now()}),h&&h.src&&c.emit(_.PLAY)})},1),n(a.contents())(e)}}return _createClass(e,[{key:"templateHTML",get:function(){return'<div class="html-state-container" id="{{vm.id}}"></div>'}}]),e}();HtmlState.$inject=["$state","$http","$compile","$sce","$timeout","iVXjs","ivxjs.actions","ivxjs.modules.audio","ivxjs.bus"],exports.default=(0,_createFactoryFunction2.default)(HtmlState);
...
},{"../../../constants/video.events.js":378,"../../../utilities/type-parsers.js":426,"../settings.js":420}],423:[function(require,module,exports){
...
},{"../../../constants/video.events.js":378,"../../../utilities/type-parsers.js":426}],424:[function(require,module,exports){
