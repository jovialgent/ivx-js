...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createFactoryFunction=require("../utilities/create-factory-function.js"),_createFactoryFunction2=_interopRequireDefault(_createFactoryFunction),_inputController=require("../utilities/input-controller.js"),CascadingOptionsInputController=function(e){function t(e,n,r,o){_classCallCheck(this,t);var i=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e,n,o)),c=i,l=e.inputData,u=c.tree,a=void 0===u?l.dataTree:u,s=l.name,p=n.experience.data;return a.options=[],a.isStatic&&a.labels.forEach(function(e,t){a.options[t]=[]}),a.options[0]=a.items,c.currentSelection=[{key:""}],c.tree=a,c.modelUpdated=function(e){var t=c.tree,n=void 0===t?{}:t,o=(n.options,n.keys,e.key),i=e.items,l=o.split("~").length-1;c.finalValue=o,i&&i.length&&(c.finalValue=i[0].key),c.currentSelection[l]=e,l<n.labels.length-1&&i&&(c.currentSelection[l+1]={key:i[0].key},n.options[l+1]=i),c.tree=n,l<n.labels.length-1&&r.emit("update-view",n),c.onChange(c.finalValue)},p[s]&&p[s].split&&!function(){var e=p[s].split("~"),t=e[0],n=(e.slice(1),t);n="",c.currentSelection=e.map(function(e,t){return n=""+(t>0?n+"~":"")+e,{key:n}});var r=c.currentSelection.reduce(function(e,t,n){var r=e[n],o=r.find(function(e){return e.key===t.key});return o&&o.items&&o.items.length&&o.items.length>=1&&(e=[].concat(e,[o.items])),e},c.tree.options);c.tree.options=r}(),r.emit("update-view",a),i}return _inherits(t,e),t}(_inputController.InputControllerHelper);CascadingOptionsInputController.$inject=["$scope","iVXjs","ivxjs.bus","ivxjs.actions"],exports.default=(0,_createFactoryFunction2.default)(CascadingOptionsInputController);
