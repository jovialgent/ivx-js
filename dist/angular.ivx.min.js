...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var n=0;n<e.length;n++){var o=e[n];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(t,o.key,o)}}return function(e,n,o){return n&&t(e.prototype,n),o&&t(e,o),e}}(),_createFactoryFunction=require("../utilities/create-factory-function.js"),_createFactoryFunction2=_interopRequireDefault(_createFactoryFunction),AnchorController=function(){function t(e,n,o,i,r){_classCallCheck(this,t),this.iVXjsActions=o,this.$window=n,this.iVXjsAudio=i,this.iVXjs=r}return _createClass(t,[{key:"onLinkClick",value:function(t){var e=this,n=this.iVXjs,o=this.anchorInfo,i=o.onClick,r=void 0===i?[]:i,a=o.href,c=o.attributes,s=void 0===c?{}:c,u=this,l=r.find(function(t,e){return"goToNextState"===t.eventName});"_blank"!==s.target&&t.preventDefault(),n.log.debug("Link with href "+a+" onLinkClick Start",{},{anchor:this.anchorInfo,source:"onClick",status:"started",actions:r,timestamp:Date.now()}),this.iVXjsActions.resolveActions(r,function(){l||(n.log.debug("Link with href "+a+" onLinkClick Ended",{},{anchor:e.anchorInfo,source:"onClick",status:"completed",actions:r,timestamp:Date.now()}),"_blank"!==s.target&&(u.$window.location=a))}),this.iVXjsAudio.audioElement.play()}}]),t}();AnchorController.$inject=["$scope","$window","ivxjs.actions","ivxjs.modules.audio","iVXjs"],exports.default=(0,_createFactoryFunction2.default)(AnchorController);
